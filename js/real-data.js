...
async function getRealCoin(symbol) {
  ...
  const riskPct = String(symbol || "").toUpperCase() === "BTC" ? 0.01 : 0.015;
  const rewardPct = String(symbol || "").toUpperCase() === "BTC" ? 0.022 : 0.03;
